...
<html>
  <head> 
    ...
    <title>Sistema de Loja <?= $this->renderSection('titulo') ?> </title>
          ...
          <div class="search-inner d-flex align-items-center justify-content-center">
            ...
            <form id="searchForm" action="#">
              <div class="form-group">
                ...
                <button type="submit" class="submit">Pesquisa</button>
              </div>
            </form>
          </div>
        </div>
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header">
            <!-- Navbar Header--><a href="index.html" class="navbar-brand">
              <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Sistema de </strong><strong>Loja</strong></div>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="tables.html"> <i class="icon-grid"></i>Clientes </a></li>
                <li><a href="charts.html"> <i class="fa fa-bar-chart"></i>Notas Fiscais </a></li>
                <li><a href="forms.html"> <i class="icon-padnote"></i>Estoque </a></li>
                <li><a href="forms.html"> <i class="icon-padnote"></i>Venda </a></li>
          ...
          <div class="footer__block block no-margin-bottom">
            <div class="container-fluid text-center">
              <!-- Please do not remove the backlink to us unless you support us at https://bootstrapious.com/donate. It is part of the license conditions. Thank you for understanding :)-->
               <p class="no-margin-bottom"><?= date('Y') ?> &copy; WL TOPOS <a target="_blank" href="#">Templates</a>.</p>
            </div>
          </div>
        </footer>
      </div>
